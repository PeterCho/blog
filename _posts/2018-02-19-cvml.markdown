---
layout: post
title:  "Work in progress: Synthesizing Face and Flower Images via DCGANs, WGANs and BEGANs"
...
training experiments.  We settled upon these hyperparameter values in the
table via trial and error.
...
But several of the DCGAN/WGAN faces also exhibit significant distortions.
Similarly, DCGAN/WGAN flowers look more like impressionistic paintings than
actual photographs.  In contrast, we find that the BEGAN images are
remarkably realistic-looking.  We consequently focus upon BEGAN results in
...
*Fig. 7.  Linear interpolations between random points in descriptor space
...
*Fig. 8.  Generated face corresponding to mean code-vector in descriptor space.*
...
17. [D.-A. Clevert, T. Unterthiner and S. Hochreiter, "Fast and Accurate
