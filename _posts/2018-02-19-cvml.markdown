...
<table style="width:100%">
  <thead>
    <tr>
      <th style="text-align: left">Encoder super layer</th>
      <th style="text-align: center">Activation volume [width x height x
channels] </th>
    </tr>
  </thead>
...
<table style="width:100%">
  <thead>
    <tr>
      <th style="text-align: left">Decoder super layer</th>
      <th style="text-align: center">Activation volume [width x height x
channels] </th>
    </tr>
  </thead>
...
12. [D.-A. Clevert, T. Unterthiner and S. Hochreiter, "Fast and Accurate
