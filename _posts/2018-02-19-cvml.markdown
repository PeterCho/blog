...
*Fig. 1.  Tensorboard display of representative face images drawn
from the CelebA training set.*

![BEGAN]({{site.url}}/blog/images/gans_faces_flowers/training_flowers_64x64.png)
*Fig. 2.  Tensorboard display of dynamically augmented images drawn from
two Oxford flower datasets.*
...
<table style="width:100%">
  <thead>
    <tr>
      <th style="text-align: left">Discriminator super layer</th>
...
channels] </th>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align: left">Conv3, Leaky Relu, stride 2</td>
    ...
    <tr>
      <td style="text-align: left">Linear proj, Sigmoid $($DCGAN$)$ or identity
$($WGAN$)$</td>
...
<table style="width:100%">
  <thead>
    <tr>
      <th style="text-align: left">Generator super layer</th>
      <th style="text-align: center">Activation volume [width x height x
channels] </th>
    </tr>
  </thead>
...
*Table 1.  DCGAN/WGAN discriminator and generator architectures.*
...
<table style="width:100%">
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align: left">$\beta_1$ coefficient</td>
      <td style="text-align: center">0.5 $($DCGAN & BEGAN$)$; 0.0 $($WGAN$)$ </td>
    </tr>
    <tr>
      <td style="text-align: left">$\beta_2$ coefficient</td>
    ...
    <tr>
      <td style="text-align: left">Z descriptor dimension</td>
    ...
    <tr>
      <td style="text-align: left">df_dim = gf_dim</td>
      <td style="text-align: center">128 $($DCGAN & BEGAN$)$; 64 $($WGAN$)$ </td>
    </tr>

</tbody>
</table>

*Table X.  Hyperparameter values employed for DCGAN, WGAN and BEGAN face synthesis.*



![BEGAN]({{site.url}}/blog/images/gans_faces_flowers/dcgan_wgan_began_faces.png)
*Fig. X.  Example 64x64 faces generated by DCGAN $($left$)$, WGAN
$($center$)$ and BEGAN $($right$)$ architectures.*

![BEGAN]({{site.url}}/blog/images/gans_faces_flowers/dcgan_wgan_began_flowers.png)
*Fig. X.  Example 64x64 flowers generated by DCGAN $($left$)$, WGAN
$($center$)$ and BEGAN $($right$)$ architectures.*
