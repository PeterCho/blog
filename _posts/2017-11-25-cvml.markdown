...
results.  So we take up this topic in the next section.
...
*Fig. 7. Movie showing PCA decompositions of 12-dimensional feature descriptors
from the final fully connected layer of CNN architecture I.  Red and blue
dots represent cat and dog descriptor projections onto the three dominant
PCA eigendirections.  The four 3D point clouds illustrate increasing
separation between cat and dog descriptors at training epochs 0, 4, 8 and 16.
Click on the image above to start the YouTube video.*




![CatsDogs]({{site.url}}/blog/images/cats_and_dogs/preferred_filters.png)
*Fig. 8.  Examples of preferred inputs for trained filters within
...
*Fig. 9.  Examples of preferred inputs for trained filters within final 
