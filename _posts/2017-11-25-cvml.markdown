...
training inputs.  Examples of augmented versions of the 160 $\times$ 160
...
fully connected layers to be useful CNN building blocks:

CBLP: Conv5, Batch norm, Leaky ReLU, Pool

CBL: Conv5, Batch norm, Leaky ReLU

BLD: Batch norm, Leaky ReLU, Dense conv5 with no bottleneck [6]
...
challenging to classify than their validation sample counterparts.  So the green
learning curve for the training subset increases more slowly
than the purple curve for the validation data in figure 4.  Yet by the end of the
...
under-fitting in this plot or others like it for our CNN
architectures I, II and III.
...
did not employ any external data from sources like ImageNet, and we
