...
training.  But the sharpness of images fed into the discriminator starts
out low and gradually increases as training proceeds.  So the GAN initially
learns gross object shapes, colors and textures from intentionally blurred
input imagery.  It later refines object parts and details as low-pass
filtering is diminished and training runs to completion.
...
equally spaced epoch intervals along the low-pass filtering schedule are
...
GAN exports bird images which are grossly comparable to their import
counterparts.
