...
We further note that Kerras *et al.* trained their bird GAN with 9X more
images than we used.  Among the bird pictures copied from ref. [1] and
reproduced here in figure 6, roughly one-third look reasonable.  But the
remaining two-thirds range from mediocre to horrible.  So consistently
generating photo-realistic bird pictures with O$($200 $\times$ 200$)$
pixels remains an outstanding challenge.
