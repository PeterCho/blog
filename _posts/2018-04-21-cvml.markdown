...
kernel's initial radius to equal 10% of the training image pixel size.
During the first 200 epochs, the blur kernel linearly ramps down to zero.
No blurring of input imagery is performed during the last 300 training
epochs.  Figure 3 plots this low-pass filtering schedule.
...
*Fig. 4.  Example discriminator inputs $($top row$)$ and generator outputs
...
*Fig. 5.  Examples of 192 $\times$ 192 generated bird images.*
