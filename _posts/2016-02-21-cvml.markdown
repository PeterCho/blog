...
correctly classified 59.44% of our 2500 test MNIST digits.  Similarly,
...[we need to compute analogous figures for a VGG-16 model finetuned on
O(60K) real MNIST digits].
...
upon individual digit recognition.  Semantic image segmentation offers a
potentially attractive mechanism for text in the wild detection.
