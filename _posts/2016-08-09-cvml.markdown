...
overall performance.  The CNN has little difficulty separating non-face
from human-face inputs.  It consequently could be used to improve precision
for detectors which find faces within internet imagery.  The 86%
correct classification rate for male faces is also respectable.  It
