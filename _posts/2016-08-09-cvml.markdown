...
the WIDER collection [2], while the remaining pictures were manually
...
dlib's image labeling tool IMGLAB [3].  The labeled faces belong to people
with differing attributes (e.g. gender, age, ethnicity) performing varying
activities (e.g. socializing, swimming, singing) in disparate settings
