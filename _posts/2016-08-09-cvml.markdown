...
*Fig. X. Examples of test image chips correctly classified by the CNN as
female.*
...
*Fig. X. Examples of female test image chips which the CNN incorrectly
classified as male.*

![FaceGender]({{site.url}}/blog/images/face_gender/results/incorrect_male_2_female_classifications.png)
*Fig. X. Examples of male test image chips which the CNN incorrectly
...
*Fig. X. Example test images in which all faces were automatically
...
*Fig. X. Example test images for which no localized face was assigned an
...
*Fig. X. Example test images in which some localized faces were assigned
