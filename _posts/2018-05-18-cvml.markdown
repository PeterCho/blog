...
GAN generator networks struggle to produce large output images that look
...
conditioned upon different flower classes within each row.  Columns in this
figure correspond to training epochs 0, 170, 340, 510 and 680.*
