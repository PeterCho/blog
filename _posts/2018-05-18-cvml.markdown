...
adopt multi-scale structure similarity $($MS-SSIM$)$ scores as an
approximate but useful perceptual metric.  MS-SSIM evalutes the similarity
between two images on a scale between 0 [radically different] to 1
[completely identical].  For each flower class, we compute the median
MS-SSIM score for 500 random pairs of images as a measure of intra-class
diversity.
...
discriminative figures of merit in these two tables represent measures
analogous to recall and precision.
...
*Table 2a. Median MS-SSIM scores calculated from 500 random pairs of images
per flower class.*
...
<table style="width:100%">
 ...
 <tbody>
    <tr>
      <td style="text-align: left">Average  accuracy  </td>
      <td style="text-align: center"> 0.877 $\pm$ 0.020     </td>
      <td style="text-align: center"> 0.728 $\pm$ 0.055  </td>
      <td style="text-align: center"> 0.851 $\pm$ 0.053   </td>
    </tr>
...
*Table 2b. Flower classifier accuracies calculated from genuine and
synthetic imagery.*
