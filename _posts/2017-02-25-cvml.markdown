...
during training [ref].  50% dropout is performed on the hidden layers
during training to combat network overfitting [ref].  L2-regularization is
also employed to discourage weight values from growing without bound.
