...
letter content of *a priori* unknown words.  Unlike the environments within
our previous RL investigations of maze and Atari pong games, the world
state is only partially observable in hangman.  So this word game involves
some interesting differences from the image-based games of our two previous
postings.
...
relatively simple.  But others like those listed in Table 1 are uncommon,
and some words originate from foreign languages that have presumably been
...
fractions of games won.  As figure XX illustrates, expected discounted
...
The game winning fraction values displayed in figure XX rise and fall even
