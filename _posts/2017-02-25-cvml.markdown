...
representation which captures English language structure.  We consequently
...
after the word vector representation.  Since our game rules permit a
maximum of 9 wrong letters, the state vector's total length is $(18+9)
\times 16 = 432$.  Initially, state vector slots 289 through 432 are filled
with 9 copies of the ascii space descriptor.  But the copies are replaced
by genuine letter descriptors as wrong guesses are made.
