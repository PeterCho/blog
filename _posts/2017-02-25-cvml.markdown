...
We start with a text file containing 355K English words obtained from the
github site in ref. [1].  We choose to ignore any words containing fewer
than 4 or more than 20 letters.  Words containing non-letter characters are
...
*Table 1.  Examples of challenging entries contained within our trimmed
"English" word corpus.*
...
line in the right histogram indicates a mean winning fraction of 0.197 for
an agent following the single letter distribution in figure XX.*
