...
Once the RL agent had finished learning, we evaluated its game playing
performance on the held-out set of 26K testing word data set.  It is
instructive to first look at the trained agent's decision making as a
