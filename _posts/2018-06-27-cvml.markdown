...
It is instructive to compare the impact of the separate L1 and CGAN terms
in the loss function as well as their time-dependent combination upon
imagery reconstruction.  We do so in the following sections where we
present flower image inpainting and colorizing results.
...
3. [JENA references goes here, "17 and 102 Category Flower
Datasets," $\small{(2008)}$.](http://www.robots.ox.ac.uk/~vgg/data/flowers/)
