...
background image of an outdoor scene. (b) Corresponding 8-bit mask indicates
character locations within words via greyscale colorings.*
...
background image of an indoor scene. (b) Corresponding 8-bit mask
indicates vertical text-line locations via greyscale colorings.*
