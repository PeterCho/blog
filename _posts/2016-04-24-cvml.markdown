...
background, text-free image of an outdoor scene. (b) Corresponding 8-bit
mask indicates character locations within words via greyscale colorings.*
...
*Fig. 6.  Horizontal and vertical text segmentation loss plotted as
functions of DNN model training.*
...
*Fig. 7.  Horizontal text segmentation results for 5 different test images.  Starting
